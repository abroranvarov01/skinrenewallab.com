...
import { Beaker, Facebook, Instagram, Twitter } from 'lucide-react'
      ...
      <div className="container mx-auto px-4 py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="space-y-4">
            ...
            <p className="text-sm text-muted-foreground leading-relaxed">
              Your trusted source for science-backed anti-aging serum reviews and recommendations.
            </p>
          </div>
        ...
        <div className="mt-8 pt-8 border-t border-border">
          <div className="flex flex-col md:flex-row justify-between items-center gap-4 text-sm text-muted-foreground">
            <p>© {new Date().getFullYear()} SkinRenewalLab.com. All rights reserved.</p>
